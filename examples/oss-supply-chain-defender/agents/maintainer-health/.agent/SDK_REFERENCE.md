...
sdk.entities.get_choiceset_values(choiceset_id: str, start: int | None=None, limit: int | None=None) -> typing.List[uipath.platform.entities.entities.ChoiceSetValue]

# Asynchronously get the values of a choice set by its ID.
sdk.entities.get_choiceset_values_async(choiceset_id: str, start: int | None=None, limit: int | None=None) -> typing.List[uipath.platform.entities.entities.ChoiceSetValue]
